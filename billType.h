...
{
public:
    void printBill();  //Change back to const.
    ...
    int width(double pharmacyCharges, double roomRent, double doctorFee);
    //Used to adjust width for arithmetic for print method in billTypeImpl.cpp.
